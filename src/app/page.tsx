...
export default function Home() {
  ...
  return (
    <div className="min-h-screen font-sans bg-gradient-to-b from-white to-zinc-50 dark:from-zinc-950 dark:to-zinc-900">
      <div className="max-w-4xl mx-auto px-6 py-10">
        ...
        <div className="rounded-xl border border-zinc-200 dark:border-zinc-800 bg-white/70 dark:bg-zinc-950/50 backdrop-blur p-6 shadow-sm">
          <Tabs
            items={[
